          ...
          <section>
            ...
            <ul>
              ...
              <li><b>年齡</b>：點「年齡」按鈕（或按 <kbd>E</kbd>）進入模式，再點人物直接打字輸入。
                  ...
                  下載的圖也一定帶著年齡。<br />
                  年齡按鈕旁的<b>「原樣／實歲」</b>標籤可以一鍵切換整張圖的顯示：民國生年（<code>82年</code>、
                  <code>82年次</code>、<code>民82</code>、<code>R82</code>）會換算成今年滿幾歲（今年民國年 − 生年），
                  <code>35</code>、<code>35y</code>、<code>35yo</code> 本來就是年齡，不換算；已歿成員也不換算。
                  只有出生年份、沒有生日，所以生日還沒到的人會多算 1 歲。切換只改變顯示，
                  打進去的字原封不動，切回「原樣」就還原。</li>
