      ...
      <aside className="help-drawer" role="dialog" aria-label="使用說明" aria-modal="false">
        ...
        <div className="help-body">
          ...
          <section>
            ...
            <table className="help-keys">
              <tbody>
                ...
                <tr><td><kbd>R</kbd></td><td>切換「年齡」模式（進入後點人物即可輸入年齡）</td></tr>
                <tr><td><kbd>Q</kbd></td><td>切換「清除」模式（點人物或婚姻線清掉其所有標記）</td></tr>
          ...
          <section>
            <h3>基本操作與家系圖繪製</h3>
            <ul>
              <li><b>節點</b>：單擊依目前模式作用——案主 <kbd>W</kbd>、同住 <kbd>E</kbd>、
                  年齡 <kbd>R</kbd>（點下去直接輸入年齡）、清除 <kbd>Q</kbd>，以及快捷列表選中的符號。
                  這幾個模式互斥，一次只會有一個生效。</li>
              <li><b>清除標記</b>：按 <kbd>Q</kbd>（或點面板右上角的「清除」）進入清除模式，
                  再點人物或婚姻線，就把那個目標身上的標記一次清光。死亡、身障、慢性病可以
                  疊在同一個人身上，用清除模式一下就乾淨，不必一個一個取消。</li>
          ...
          <section>
            ...
            <p className="help-note">
              要一次清乾淨就用<b>「清除」模式</b>（面板右上角，快捷鍵 <kbd>Q</kbd>）：進入後點人物
              或婚姻線，該目標身上的標記全部清掉。人物標記可以疊很多個，一個一個取消很累，這個模式
              就是為了那種情況；婚姻線只會有一種關係品質，兩種做法效果一樣。
            </p>
            <p className="help-note">
