        ...
        <div className="help-body">
          ...
          <section>
            ...
            <ul>
              ...
              <li><b>積木工具箱</b>與<b>自由擴充區</b>預設收合，點標題列即可展開；平常畫面只留第一代／第二代這條主線。</li>
            </ul>
          </section>
          ...
          <section>
            <h3>積木工具箱</h3>
            <p>
              從左側工具箱（預設收合，點標題展開）<b>拖曳符號放開</b>即可套用：拖到人物上是個人標記，
          ...
          <section>
            ...
            <ul>
              ...
              <li><b>時間軸快照</b>收在案件列的 <b>🕰️</b> 底下：可隨時存一份目前的家系圖、之後還原回那個時間點。快照跟著案件走，重新整理仍在；還原錯了可用 <kbd>Ctrl</kbd>＋<kbd>Z</kbd> 復原。</li>
